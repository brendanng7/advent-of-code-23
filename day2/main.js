const data = `Game 1: 2 blue, 3 red; 3 green, 3 blue, 6 red; 4 blue, 6 red; 2 green, 2 blue, 9 red; 2 red, 4 blue
...
for (let i = 0; i < filter2.length; i++) {
    ...
    for (let j = 0; j < subsets.length; j++) {
        ...
        red = Math.max(subset.indexOf("red") - 2 >= 0 ? parseInt(subset.slice(subset.indexOf("red") - 3, subset.indexOf("red"))) : 0, red);
        green = Math.max(subset.indexOf("green") - 2 >= 0 ? parseInt(subset.slice(subset.indexOf("green") - 3, subset.indexOf("green"))) : 0, green);
        blue = Math.max(subset.indexOf("blue") - 2 >= 0 ? parseInt(subset.slice(subset.indexOf("blue") - 3, subset.indexOf("blue"))) : 0, blue);
    }
    if (possible) {
        sum += red * green * blue;
    }
